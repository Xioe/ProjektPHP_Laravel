...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1645349498ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=passmanager&table=cardstable">`passmanager`.`cardstable`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=passmanager&table=migrations">`passmanager`.`migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=passmanager&table=passtable">`passmanager`.`passtable`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=passmanager&table=personaldatatable">`passmanager`.`personaldatatable`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=passmanager&table=personal_access_tokens">`passmanager`.`personal_access_tokens`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=passmanager&table=users">`passmanager`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=passmanager&table=password_resets">`passmanager`.`password_resets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=PZSIWPHP2&table=Posts">`PZSIWPHP2`.`Posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=PZSIWPHP2&table=internalevents">`PZSIWPHP2`.`internalevents`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pzsiqphp&table=Posts">`pzsiqphp`.`Posts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6150423d5735693e5c6b2361532c5358">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="passmanager" targettable="users">
            ...
            Queried time
                            ...
                            targetdb="passmanager" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE users
  RENAME TO users23;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="passmanager" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="passmanager" targettable="passtable">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `passtable`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="passmanager" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="passmanager" targettable="password_resets">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `password_resets`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="passmanager" targettable="personaldatatable">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `personaldatatable`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="passmanager" targettable="cardstable">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cardstable`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="passmanager" targettable="cardstable">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="passmanager" targettable="personal_access_tokens">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `passtable`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="passmanager" targettable="migrations">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
